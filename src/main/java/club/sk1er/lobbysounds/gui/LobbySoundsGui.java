...
public class LobbySoundsGui extends AbstractScreen {
    ...
    @Override
    public void initGui() {
        createButton(0, 155, 0, getSuffix(Sounds.DISABLE_DRAGON_SOUNDS, "Dragon Sounds"));
        createButton(1, 5, 0, getSuffix(Sounds.DISABLE_EXPERIENCE_SOUNDS, "Experience Sounds"));
        createButton(2, 155, 1, getSuffix(Sounds.DISABLE_ITEM_PICKUP_SOUNDS, "Item Pickup Sounds"));
        createButton(3, 5, 1, getSuffix(Sounds.DISABLE_SLIME_SOUNDS, "Slime Sounds"));
        createButton(4, 155, 2, getSuffix(Sounds.DISABLE_WITHER_SOUNDS, "Wither Sounds"));
        createButton(5, 5, 2, getSuffix(Sounds.DISABLE_TNT_PRIME_SOUNDS, "Tnt Prime Sounds"));
        createButton(6, 155, 3, getSuffix(Sounds.DISABLE_EXPLOSION_SOUNDS, "Explosion Sounds"));
        createButton(7, 5, 3, getSuffix(Sounds.DISABLE_DELIVERY_MAN_SOUNDS, "Delivery Man Sounds"));
        createButton(8, 155, 4, getSuffix(Sounds.DISABLE_NOTE_SOUNDS, "Note Sounds"));
        createButton(9, 5, 4, getSuffix(Sounds.DISABLE_FIREWORKS_SOUNDS, "Fireworks Sounds"));
        createButton(10, 155, 5, getSuffix(Sounds.DISABLE_LEVELUP_SOUNDS, "Levelup Sounds"));
        createButton(11, 5, 5, getSuffix(Sounds.DISABLE_STEP_SOUNDS, "Step Sounds"));
        createButton(12, 155, 6, getSuffix(Sounds.DISABLE_ARROW_SOUNDS, "Arrow Sounds"));
        createButton(13, 5, 6, getSuffix(Sounds.DISABLE_BAT_SOUNDS, "Bat Sounds"));
        createButton(14, 155, 7, getSuffix(Sounds.DISABLE_FIRE_SOUNDS, "Fire Sounds"));
        createButton(15, 5, 7, getSuffix(Sounds.DISABLE_ENDERMEN_SOUNDS, "Enderman Sounds"));
    }
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 14:
                ...
                break;
            case 15:
                Sounds.DISABLE_ENDERMEN_SOUNDS = !Sounds.DISABLE_ENDERMEN_SOUNDS;
                button.displayString = getSuffix(Sounds.DISABLE_ENDERMEN_SOUNDS, "Endermen Sounds");
                break;
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(mc.fontRendererObj, EnumChatFormatting.GREEN + "Green means the sound is enabled, "
                + EnumChatFormatting.RED + "red means the sound is disabled.", width / 2, getRowPos(-1) + 8, -1);
